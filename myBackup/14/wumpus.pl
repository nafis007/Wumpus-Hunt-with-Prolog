...
getRandomMovesList(Direction,Energy,L) :- 
  ...
  generateNRandomMoves(RandomDirection,Depth,L1),
  length(L1,Len), RemainingEnergy is (Energy - Len),
  %getAssumedValidPath(RandomDirection,Energy,RemainingEnergy,L1),
  ...
  getRandomDirection(Direction,RandomDirection),
  getMazeDimenstion(RandomDirection,Dimension), 
  Depth is min(EnergyAfterShoot,Dimension),
  generateNRandomMoves(RandomDirection,Depth,L1),
  length(L1,Len), RemainingEnergy is (EnergyAfterShoot - Len),
  %getAssumedValidPath(RandomDirection,EnergyAfterShoot,RemainingEnergy,L1), 
...
getAssumedValidPath(Direction,Energy,RemainingEnergy,MoveList) :- 
  getMazeDimenstion(Direction,Dimension), 
  Depth is min(Energy,Dimension),
